...
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_js_1.default.query("SELECT * FROM public.locations")];
            case 1:
                res = _a.sent();
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_js_1.default.query("SELECT * FROM public.locations WHERE id=$1", [id])];
            case 1:
                res = _a.sent();
                if (res.rowCount === 0)
...
var deleteById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_js_1.default.query("DELETE FROM public.locations WHERE id=$1", [id])];
            case 1:
                res = _a.sent();
                if (res.rowCount === 0)
                    throw new index_js_1.IPFNotFoundError("");
...
var updateById = function (newLocation) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var create = function (newLocation) { return __awaiter(void 0, void 0, void 0, function () {
    var res;
    return __generator(this, function (_a) {
        switch (_a.label) {
