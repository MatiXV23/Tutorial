...
var swaggerOpts = {
    openapi: {
        info: {
            title: "API PARCIAL",
            summary: "Summary: Api creado para el parcil 1 de Desarrollo web y mobile.",
...
exports.default = (0, fastify_plugin_1.default)(function (fastify, opts) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fastify.register(swagger_1.default, swaggerOpts)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, fastify.register(swagger_ui_1.default, {
                            routePrefix: "docs",
                            uiConfig: {
                                docExpansion: "none",
                                deepLinking: false,
                            ...
                            transformSpecification: function (swaggerObject, request, reply) {
