...
var descripcionPost = " ## Implementar y validar \n " +
    "- token \n " +
        ...
        fastify.get("/", {
            schema: {
                ...
                response: {
                    200: {
                        ...
                        content: {
                            "application/json": {
                                schema: typebox_1.Type.Array(usuario_js_1.Usuario),
                            },
                        },
                    },
                },
            ...
            handler: function (request, reply) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, usuarioService.findAll()];
                    });
                });
            },
        });
        fastify.post("/", {
            ...
            handler: function (request, reply) {
                return __awaiter(this, void 0, void 0, function () {
                    var nuevoUsuario;
                    return __generator(this, function (_a) {
                        nuevoUsuario = request.body;
                        reply.code(201);
                        return [2 /*return*/, usuarioService.create(nuevoUsuario)];
                    });
                });
            },
        });
